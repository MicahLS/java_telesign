...
public class RestClient {
	 ...
	 */
	public Map<String, String> generateTelesignHeaders(String methodName, String resource, String requestParams,
			String dateRfc2616, String nonce, String userAgent) throws NoSuchAlgorithmException, InvalidKeyException {
		...
		SecretKeySpec secretKeySpec = new SecretKeySpec(DatatypeConverter.parseBase64Binary(this.apiKey), "HmacSHA256");
		sha256HMAC.init(secretKeySpec);
		signature = DatatypeConverter.printBase64Binary(sha256HMAC.doFinal(stringToSign.getBytes()));

		String authorization = String.format("TSA %s:%s", this.customerId, signature);
	...
	private TelesignResponse execute(String methodName, String resource, Map<String, ? extends Object> params)
		...
		Map<String, String> headers = this.generateTelesignHeaders(methodName, resource, requestParams, null, null, RestClient.userAgent);
